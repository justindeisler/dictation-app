...
- [x] **ERR-01**: User receives notification when transcription fails
- [x] **ERR-02**: Error notification explains why it failed (network, API key, timeout)
- [x] **ERR-03**: App handles missing API key gracefully (prompts to configure)
- [x] **ERR-04**: App handles network unavailable gracefully
